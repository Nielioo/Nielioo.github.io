         ...
         <main>
            <section className="">
               <div className="layout">
                     ...
                     {frontmatter.github && (
                        <div className="inline-flex items-center gap-2">
                           ...
                           <CustomLink
                              onClick={() =>
                                 trackEvent(
                                    `Project Github: ${frontmatter.title}`,
                                    {
                                       type: "link",
                                    }
                                 )
                     ...
                     {frontmatter.youtube && (
                        <div className="inline-flex items-center gap-2">
                           ...
                           <CustomLink
                              ...
                              onClick={() =>
                                 trackEvent(
                                    `Project Video: ${frontmatter.title}`,
                                    {
                                       type: "link",
                                    }
                                 )
                     ...
                     {frontmatter.link && (
                        <div className="inline-flex items-center gap-2">
                           ...
                           <CustomLink
                              ...
                              onClick={() =>
                                 trackEvent(
                                    `Project Live: ${frontmatter.title}`,
                                    {
                                       type: "link",
                                    }
                                 )
                  ...
                  <section className="lg:grid lg:grid-cols-[auto,250px] lg:gap-8 mt-4">
                  ...
                  <div className="mt-48 flex flex-col items-start gap-4 md:flex-row-reverse md:justify-between">
                     <CustomLink
                        href={`https://github.com/nielioo/nielioo.github.io/blob/main/src/contents/projects/${frontmatter.slug}.mdx`}
                     >
                        Edit this on GitHub
                     </CustomLink>
